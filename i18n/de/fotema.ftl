...
prefs-albums-selfies = Selfies
    .subtitle = Zeigt ein separates Album für Selfies, die mit iOS-Geräten aufgenommen wurden. Starten Sie { -app-name } neu, um es anzuwenden.
prefs-albums-chronological-sort = Sortierung
    .subtitle = Chronologische Sortierreihenfolge für Alben.
    .ascending = Aufsteigend
    .descending = Absteigend
prefs-processing-section = Foto- und Videobearbeitung
